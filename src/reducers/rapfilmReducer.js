...
function rapfilmReducer(state = initialState, action) {
  switch (action.type) {
    case "rapfilm/da_Chon": {
      const { soGhe } = action.payload;
      let tongTien=0; // declare tongTien variable here
